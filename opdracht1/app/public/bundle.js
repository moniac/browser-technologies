...
var sections = {
	init: function init() {
		_settings2.default.sections.forEach(function (el) {
...
var Routie = function Routie(w, isModule) {
  ...
  var routie = function routie(path, fn) {
    if (typeof fn === 'function') {
      addHandler(path, fn);
      routie.reload();
    } else if ((typeof path === 'undefined' ? 'undefined' : (0, _typeof3.default)(path)) === 'object') {
      for (var p in path) {
        addHandler(p, path[p]);
      }
      routie.reload();
  ...
  function i(s, u) {
    ...
    var r,
      ...
      function t(t, e) {
        ...
        var n, r, o, s;if (i.isElement(t) && (n = this.elements[0])) return n.empty().el.appendChild(t);if ("object" == (typeof t === "undefined" ? "undefined" : (0, _typeof3.default)(t))) {
          o = [];for (r in t) {
            ...
            }.call(this)) : "object" == (typeof s === "undefined" ? "undefined" : (0, _typeof3.default)(s)) ? o.push(e.push(r)) : o.push(void 0)));
          }return o;
        }
      }), t.prototype.renderDirectives = o(function (t, e, n) {
        var r, i, o, s;s = [];for (o in n) {
          u.call(n, o) && (r = n[o], "object" == (typeof r === "undefined" ? "undefined" : (0, _typeof3.default)(r)) && ("object" != (typeof t === "undefined" ? "undefined" : (0, _typeof3.default)(t)) && (t = { value: t }), s.push(function () {
    ...
    var r = {};r.toString = Object.prototype.toString, r.toArray = function (t) {
      ...
      var e;return e = typeof t === "undefined" ? "undefined" : (0, _typeof3.default)(t), "object" !== e && "function" !== e || n.isDate(t);
...
var _promisePolyfill = __webpack_require__(68);

var _promisePolyfill2 = _interopRequireDefault(_promisePolyfill);

__webpack_require__(73);

var _init = __webpack_require__(74);
...
var settings = {
	sections: (0, _from2.default)(document.querySelectorAll('section'))
};
...
var _routie = __webpack_require__(50);
...
var _paths = __webpack_require__(120);
	...
	init: function init() {
		(0, _routie2.default)({
			...
			'pokemon': function pokemon() {
				_paths2.default.pokemonList();
			},
			'pokemon/?:name': function pokemonName(name) {
				_paths2.default.pokemonDetail(name);
			}
		});
	},
	checkHash: function checkHash() {
		if (window.location.hash) {
			_sections2.default.toggle(_helpers2.default.splitHash(location.hash));
		} else {
...
var paths = {
	pokemonList: function pokemonList() {
		_sections2.default.toggle("pokemon");
		_helpers2.default.toggleLoader();
		_api2.default.call('https://pokeapi.co/api/v2/pokemon/?limit=151').then(function (data) {
			_helpers2.default.toggleLoader();
			var directives = {
				name: {
					href: function href() {
			...
			var pokemonInput = document.querySelector('#pokemon > input').addEventListener('keyup', function (e) {
	...
	pokemonDetail: function pokemonDetail(name) {
		_helpers2.default.toggleLoader();
		_api2.default.call('https://pokeapi.co/api/v2/pokemon/' + name).then(function (data) {
			_helpers2.default.toggleLoader();
			...
			_sections2.default.toggle(name);
